...
import { 
  ...
  Pill, ClipboardList, User, Home
} from 'lucide-react';

const PatientRegistration = ({ supabase, onSuccess, onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(`Patient registered successfully! Patient Number: ${patient_number}`);
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-end space-x-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-colors shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
