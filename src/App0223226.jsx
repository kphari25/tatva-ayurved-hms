      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-gradient-to-b from-blue-800 to-blue-900 text-white transition-all duration-300 flex flex-col`}>
            ...
            {sidebarOpen ? (
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-200">HMS</p>
                </div>
              </div>
            ) : (
        ...
        <div className="p-4 border-b border-blue-700">
          <button
            ...
            className={`w-full flex items-center ${sidebarOpen ? 'space-x-3 justify-start' : 'justify-center'} px-4 py-3 bg-white text-blue-800 rounded-lg hover:bg-blue-50 transition-all shadow-lg font-semibold`}
          >
          ...
          {currentView === 'dashboard' && (
            <div>
              ...
              <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-8 text-white mb-8">
                ...
                <button
                  onClick={() => setShowPatientRegistration(true)}
                  className="px-6 py-3 bg-white text-blue-700 rounded-lg hover:bg-blue-50 transition-colors font-semibold shadow-lg"
                >
